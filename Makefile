...
bin/kärna.bin: $(BASIC) src/kärna/*.asm bin/strings.asm bin/färger.asm
	mkdir -p bin
...
bin/färger2asm: $(BASIC) verktyg/färger2asm/main.go
	go build -o bin/färger2asm verktyg/färger2asm/main.go

bin/strings.asm: $(BASIC) bin/strings2asm resurser/se.strings
	bin/strings2asm resurser/se.strings bin/strings.asm

bin/färger.asm: $(BASIC) bin/färger2asm resurser/palette.json
	bin/färger2asm resurser/palette.json bin/färger.asm
